...
class FeatureSelectViewController: UITableViewController
{
    var featureArray = ["Chat Sample", "朋友圈 Sample"]
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell
    {
        ...
        // Configure the cell...
        cell.textLabel?.text = featureArray[indexPath.row]
